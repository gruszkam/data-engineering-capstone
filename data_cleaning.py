...
from udf import travel_udf, visa_udf, country_udf,\
...
def state_data(spark, input_data, output_data):
    ...
    # Assign correct data types and order data by state names
    cities = cities\
    ...
    # Calculate percentages of demographic characteristics for easy comparisons
    states = states\
